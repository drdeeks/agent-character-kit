...
description: Add, update, delete, or retune Agent Character Kit habits, hold frequency, required acknowledgments, allow/deny lists, hard constraints, and workspace files in Claude Code. Use when the user wants to customize ACK, not when a tool is merely held.
---
